 ...
 *
 * <p>The test uses {@code webEnvironment = SpringBootTest.WebEnvironment.MOCK} to avoid
 * starting a real server, and {@code @AutoConfigureMockMvc} to inject the {@link MockMvc}
 * test client.</p>
 */
